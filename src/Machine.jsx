...
const Machines = ({ machines, setMachines }) => {
  ...
  useEffect(() => {
    axios
      .get("https://api-start-pira-tst.vercel.app/api/machines")
      .then((response) => {
  ...
  const handleAddMachine = () => {
    if (newMachine.trim() !== "") {
      axios
        .post("https://api-start-pira-tst.vercel.app/api/machines", { name: newMachine })
        .then((response) => {
  ...
  const handleDeleteMachine = (machineId) => {
    ...
    axios
      .delete(`https://api-start-pira-tst.vercel.app/api/machines/${parsedMachineId}`)
      .then(() => {
